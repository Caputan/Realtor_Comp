...
namespace RieltorComp
{
    public partial class SellForm : Form
    {
        ...
        public SellForm(string ownerName, string ownerPassport, string clientName, 
        ...
        private void createSellButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var service = _servicesTable.GetService("Купля/Продажа");
                Contracts newContract = new Contracts()
                {
                    ...
                    Service_Price = double.Parse(sellPriceTB.Text)
                };

...
namespace RieltorComp
{
    public partial class LoanForm : Form
    {
        ...
        public LoanForm(string ownerName, string ownerPassport, string clientName, 
        ...
        private void createLoanButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var service = _servicesTable.GetService("Ипотека");
                ...
                Contracts newContract = new Contracts()
                {
                    ...
                    Service_Price = double.Parse(loanPriceTB.Text),
                    Service_Period = loanPeriodTB.Text,
                    Service_Persent = persentTB.Text
                };
        ...
        private void cancelLoanButton_Click(object sender, EventArgs e)
        {
            Hide();
            new RealtorForm(_realtorName).ShowDialog();
            Close();
